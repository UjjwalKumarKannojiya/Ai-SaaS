...
export const PlanContent = (props: PlanContentProps) => (
  <CollapsibleContent className="p-6 pt-0" data-slot="plan-content" {...props} />
);
...
export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  <CollapsibleTrigger 
    className={cn(
      ...
      "hover:bg-accent hover:text-accent-foreground [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      "size-8",
      className
    )} 
